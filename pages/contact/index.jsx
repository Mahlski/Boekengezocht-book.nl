    ...
    <div className="bg-gray-50 h-screen ">
      ...
      <div className="px-20">
        <div className="border rounded-lg m-auto bg-white mt-4 mx-30  p-10 ">
          <h1>Contact Form</h1>
          <p>
            Get in contact with us with this form. We will reply to you as soon
            as possible.
          </p>
          ...
          <form className="flex flex-col" onSubmit={submitHandler}>
            ...
            {name && email && msg ? (
              <button
                className="bg-green-700 text-white py-2 px-4 mt-5 rounded-sm"
                type="submit"
              >
                Send
              </button>
              ...
              <button
                ...
                className="bg-green-100 text-white py-2 px-4 mt-5 rounded-sm"
                disabled
              >
                Send
              </button>
